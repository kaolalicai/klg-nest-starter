...
class NumberUtil {
    ...
    static fixedNumUp(num, digits = NumberUtil.defaultDigits) {
     ...
     * @returns {number}
     */
    static fixedNum(num, digits = NumberUtil.defaultDigits) {
     ...
     * @returns {number}
     */
    static cutNum(num, digits = NumberUtil.defaultDigits) {
        num = this.fixNumPrecision(num);
        return _.floor(num, digits);
    }
}
exports.NumberUtil = NumberUtil;
NumberUtil.defaultDigits = 2;
